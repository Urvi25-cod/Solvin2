...
const Founder = () => {
    return (
        <>
            ...
            >
                ...
                <div className="relative h-full flex flex-col justify-center px-6 md:px-12 lg:px-20">
                    ...
                    <div className="mb-2 text-white text-sm md:text-base">
                        ...
                        <span className="mx-2">/</span>
                        <a href="/Founder" className="hover:text-orange-400 transition-colors">Founder</a>
                    </div>
            ...
            {/* Founder Section */}
            <div className="px-4 md:px-6 lg:px-12 py-20">
                <div className="flex flex-col lg:flex-row items-center lg:items-start bg-white p-4 md:p-12">
                    
                    {/* Left Section - Image */}
                    <div className="relative w-full lg:w-1/2 flex justify-center">
                        <div className="xl:w-80 w-[95%] md:w-[60%] lg:w-[100%] xl:h-[600px] h-[500px] md:h-[500px] bg-orange-500"></div>
                        <img
                            src={Boy}
                            alt="Profile"
                            className="absolute w-[90%] h-[400px] md:w-[95%] md:left-[20%] lg:left-[10%] md:h-[80%] xl:h-[70%] xl:left-25 xl:top-23 top-15 md:top-10 left-10 object-contain"
                        />
                    </div>

                    {/* Right Section - Text Content */}
                    <div className="w-full lg:w-1/1 px-4 md:px-8 mt-10 lg:mt-0">
                        <p className="text-orange-500 font-semibold text-sm">Co-founder & CEO</p>
                        <h1 className="text-[#1F4278] font-bold text-2xl md:text-3xl mt-2">Brijeshkumar Kakdiya</h1>
                        ...
                        <p className="text-blue-800 text-sm md:text-base mt-4 leading-relaxed text-justify">
                            Our vision is to become the world's leading supplier of raw materials, semi-finished products, and finished goods
                            across all industries. Through our commitment to efficiency, reliability, and innovation, we aim to empower global
                            businesses to achieve seamless operations and exceptional growth, benefiting all our stakeholders.
                        </p>

                        <p className="text-blue-800 text-sm md:text-base mt-4 leading-relaxed text-justify">
                            Our mission is to revolutionize the global market through a customer-centric approach and advanced technologies.
                            We strive to deliver superior products and services promptly, fostering long-term partnerships and driving global commerce.
                            By eliminating delays and enhancing efficiency, we empower our clients to achieve their goals and succeed
                            in a competitive market.
                        </p>
                    </div>
                </div>
