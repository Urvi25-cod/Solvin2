...
//                 }}
//               >
//                 <div className="w-full h-60 bg-white rounded-lg  p-6 text-center flex flex-col items-center justify-center border border-gray-200">
...
const About2 = () => {
  // For SSR safety, set a default card width
  const cardWidth = typeof window !== "undefined" ? getCardWidth() : 22;
