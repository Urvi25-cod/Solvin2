...
//           <div
//             key={index}
//             className="flex flex-col items-center justify-center p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 cursor-pointer"
//           >
//             {/* Icon Placeholder */}
//             <div
//               className={`text-orange-500 text-4xl mb-4 ${
//                 category.name === "Industrial Chemicals" ? "bg-orange-100 p-4 rounded-lg shadow-md" : ""
//               }`}
//             >
...
//                 category.name === "Industrial Chemicals" ? "text-orange-500 font-bold" : ""
//               }`}
//             >
//               {category.name}
//             </p>
