...
const Frame = () => {
  return (
    ...
    <section className="px-6 py-12 grid grid-cols-1 lg:grid-cols-2 gap-6 items-center md:px-17">
      ...
      <div className="px-4 sm:px-8 text-center sm:text-left">
        ...
        <div className="mt-6 flex flex gap-6">
          <div>
            <p className="text-orange-500 text-2xl font-bold">250+</p>
            <p className="text-[#1F4278] text-sm">Successful partnerships</p>
          </div>
          <div>
            <p className="text-orange-500 text-2xl font-bold">31+</p>
            <p className="text-[#1F4278] text-sm">Countries Covered</p>
          </div>
          <div>
            <p className="text-orange-500 text-2xl font-bold">9+</p>
            <p className="text-[#1F4278] text-sm">Years of experience</p>
          </div>
        </div>
      </div>
    </section>
